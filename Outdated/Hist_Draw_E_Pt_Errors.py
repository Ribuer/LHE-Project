...
dm_e_hist.Draw("E1")
med_e_hist.Draw("E1same")
top_e_hist.Draw("E1same")
bot_e_hist.Draw("E1same")
...
c1.Print("DM_Mediator_T_B Energy Hist_Error.pdf")

del legend

dm_pt_hist.Draw("E1")
med_pt_hist.Draw("E1same")
top_pt_hist.Draw("E1same")
bot_pt_hist.Draw("E1same")
...
c1.Print("DM_Mediator_T_B Transverse Momentum Hist_Error.pdf")
