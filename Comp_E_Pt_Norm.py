...
Change y-axis in plots: Set # on Ln 50
Draw without error bars: Set # on Ln 60
Save files as png: replace ".pdf" with ".png" on Ln 53
...
def make_hists(counter):
	...
	#TH1.SetDefaultSumw2(True)	#For drawing and scaling the error bars
